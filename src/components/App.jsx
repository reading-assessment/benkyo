...
import {SetCurrentProfile, SetCurrentClasses, SetAllAssigments, SetActiveAssignment} from './Students/StudentActions'
...
export default class App extends React.Component {
      ...
      firebase.auth().onAuthStateChanged(function(user) {
        ...
        if (user){
          ...
          firebase.database().ref(`classes`).once('value').then(function(snapshot){
            ...
            snapshot.forEach(function(classroom){
              ...
              for (var id in students){
                ...
                if (students[id].profile.emailAddress === user.email){
                  ...
                  this.props.dispatch(SetCurrentClasses(newClass));
            ...
            this.props.dispatch(SetCurrentProfile(lastProfile));
  ...
  render() {
    ...
    if (change_main_view === 'Login' && role === 'Teacher') {
        ...
        var renderLogin = (
          <StudentLogin resetAuthState={this.setAuthState}/>
        )
